/**
 * Class is a class to store values of classes in your schedule such as: start
 * time, end time, name, professor and credits
 * 
 * @author Josh Cohen
 * @version 1.01
 */
public class Class
{
	...
	/**
	 * Initializes new Class with a given name, professor, beginning Time and
	 * ending Time.
	 * 
