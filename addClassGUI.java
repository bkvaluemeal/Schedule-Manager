...
public class addClassGUI extends JDialog
{
    ...
    public class event implements ActionListener
    {
        public void actionPerformed(ActionEvent a) 
        {
            ...
            newClass = new Class(name,teacher,beginningTime,endingTime,creditVal,days);
            
            if(newClass.getBeginningTime().equals("8:00") || newClass.getBeginningTime().equals("8"))
            {
                ScheduleManager.classOne.setText(newClass.toString());
            }
            else if(newClass.getBeginningTime().equals("7:00") || newClass.getBeginningTime().equals("7"))
            {
